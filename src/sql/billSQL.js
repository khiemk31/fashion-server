module.exports = {
    ...
    queryBillByBillID: `SELECT bill.bill_id,bill.status, user.phone, user.user_name, bill.address , bill.created_at ,bill.total_price ,bill.discount_voucher_price ,bill.cancellation_reason , bill.feedback , bill.return_request ,bill.feedback_by_store FROM bill , user WHERE bill.user_id = user.user_id AND bill_id=?`,
