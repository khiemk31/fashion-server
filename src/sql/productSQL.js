module.exports = {
  ...
  detailProductQuery: `select  product_id, product_name ,price ,product_image ,product_bgr1 ,product_bgr2 ,product_bgr3  from product where deleted_at is null and product_id=?`,
  listSizeProductQuery: `select size , quantity from size where  product_id=?`,
