module.exports = {
    ...
    getAllProduct: `SELECT product.product_id ,product.product_name,category.category_name, product.product_image , product.price , product.discount  from  product , category WHERE  product.category_id = category.category_id and  product.deleted_at is NULL and category.deleted_at is NULL ORDER BY product.discount DESC`,
